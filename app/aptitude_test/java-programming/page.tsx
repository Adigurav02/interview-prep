...
// --- DATA: This data is specific to the Java Programming category page ---
...
export default function JavaProgrammingPage() {
  const parentSlug = "java-programming"; // This should match the folder name
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-4">
          {programmingTopics.map(topic => (
            ...
            // For example: /aptitude_test/java-programming/language-fundamentals
            <Link 
              key={topic} 
