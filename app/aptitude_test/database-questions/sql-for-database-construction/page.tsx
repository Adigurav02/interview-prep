...
// --- DATA: This data is specific to the SQL for Database Construction page ---
...
const generalQuestions = [
  ...
  {
    question: "SQL views can be used to hide:",
    options: [
  ...
  },
  {
    ...
    options: ["CREATE VIEW.", "MAKE VIEW.", "SELECT VIEW.", "INSERT VIEW."],
    answer: "A",
    explanation: [
        { type: 'discuss', content: "No answer description is available." }
    ]
...
// --- MAIN PAGE COMPONENT ---
export default function SqlForDatabaseConstructionPage() {
    ...
    <div className="bg-white min-h-screen">
      <main className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
        <div className="border border-gray-200 rounded-lg p-6">
          <p className="text-sm text-gray-500 mb-4">Exercise : <span className="font-semibold text-green-600">SQL for Database Construction</span></p>
