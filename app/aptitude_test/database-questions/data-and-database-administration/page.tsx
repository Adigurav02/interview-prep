...
// --- DATA: This data is specific to The Database Development Process page ---
...
const generalQuestions = [
  {
    question: "Which of the following database activities allow for the actual retrieval and use of a database?",
    options: ["Enterprise modeling", "Logical database design", "Physical database design and definition", "Database implementation"],
    answer: "D",
    explanation: [
  ...
  },
  {
    ...
    options: ["internal schema.", "conceptual schema.", "programming schema.", "external schema."],
    answer: "C",
    explanation: [
      { type: 'discuss', content: "No answer description is available." }
    ]
  ...
  {
    question: "Which is not a type of data management technology?",
    options: ["Relational", "Rational", "Object-oriented", "Dimensional"],
    answer: "B",
    explanation: [
      { type: 'discuss', content: "No answer description is available." }
    ]
  ...
  {
    question: "Which is not a relevant feature of CASE tools?",
    options: [
...
// --- MAIN PAGE COMPONENT ---
export default function TheDatabaseDevelopmentProcessPage() {
  ...
  // Changed the typo `perPage` to the correctly defined `questionsPerPage`
  // ================================================================= //
    ...
    <div className="bg-white min-h-screen">
      <main className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
        <div className="border border-gray-200 rounded-lg p-6">
          <p className="text-sm text-gray-500 mb-4">Exercise : <span className="font-semibold text-green-600">The Database Development Process</span></p>
