...
// --- DATA: This data is specific to the Managing Databases with Oracle page ---
...
const generalQuestions = [
  {
    question: "What type of failure occurs when Oracle fails due to an operating system or computer hardware failure?",
    options: ["Application Failure", "Instance Failure", "Media Failure", "Rollback failure"],
    answer: "B",
    explanation: [
  ...
  {
    question: "Which statement about sequences is not true?",
    options: [
        ...
        "NextVal and CurrVar are both sequence methods.", 
  ...
  },
  {
    ...
    options: [":new only", ":old only", "Both :new and :old", "Neither :new nor :old"],
    answer: "C",
    explanation: [
      { type: 'discuss', content: "No answer description is available." }
    ]
  ...
  {
    question: "In creating a procedure, you may get a message if you have compile errors. Which of the following is true?",
    options: [
...
// --- MAIN PAGE COMPONENT ---
export default function ManagingDatabasesWithOraclePage() {
    ...
    <div className="bg-white min-h-screen">
      <main className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
        <div className="border border-gray-200 rounded-lg p-6">
          <p className="text-sm text-gray-500 mb-4">Exercise : <span className="font-semibold text-green-600">Managing Databases with Oracle</span></p>
