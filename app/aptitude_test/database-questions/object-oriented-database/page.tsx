...
// --- DATA: This data is specific to the Object-Oriented Database page ---
...
const generalQuestions = [
  {
    question: "ODL supports which of the following types of association relationships?",
  ...
  {
    question: "An extent is which of the following?",
    options: [
  ...
  {
    question: "Identify the class name for the following code: ABC123 course();",
    options: ["ABC123", "course", "course()", "All of the above."],
    answer: "A",
    explanation: [
      { type: 'discuss', content: "No answer description is available." }
    ]
  ...
  {
    question: "Using ODL, you can define which of the following?",
  ...
  {
    question: "The keyword \"inverse\" is used in which of the following?",
    options: ["Class", "Attribute", "Relationship", "All of the above."],
    answer: "C",
    explanation: [
        { type: 'discuss', content: "No answer description is available." }
    ]
...
// --- MAIN PAGE COMPONENT ---
export default function ObjectOrientedDatabasePage() {
    ...
    <div className="bg-white min-h-screen">
      <main className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
        <div className="border border-gray-200 rounded-lg p-6">
          <p className="text-sm text-gray-500 mb-4">Exercise : <span className="font-semibold text-green-600">Object-Oriented Database</span></p>
