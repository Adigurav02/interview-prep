...
// --- DATA: This data is specific to the Advanced SQL page ---
...
// --- MAIN PAGE COMPONENT ---
export default function AdvancedSqlPage() {
    ...
    <div className="bg-white min-h-screen">
      <main className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
        <div className="border border-gray-200 rounded-lg p-6">
          <p className="text-sm text-gray-500 mb-4">Exercise : <span className="font-semibold text-green-600">Advanced SQL</span></p>
