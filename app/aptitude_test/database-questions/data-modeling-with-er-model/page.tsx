...
// --- DATA: This data is specific to the Data Modeling with ER Model page ---
...
const generalQuestions = [
  {
    ...
    options: ["Minimum cardinality", "Maximum cardinality", "ERD", "Greater Entity Count (GEC)"],
    answer: "B",
    explanation: [
  ...
  {
    question: "Which type of entity cannot exist in the database unless another type of entity also exists in the database, but does not require that the identifier of that other entity be included as part of its own identifier?",
  ...
  {
    question: "In a one-to-many relationship, the entity that is on the one side of the relationship is called a(n) ________ entity.",
    options: ["parent", "child", "instance", "subtype"],
    answer: "A",
    explanation: [
      { type: 'discuss', content: "No answer description is available." }
    ]
  ...
  {
    question: "Which type of entity represents an actual occurrence of an associated generalized entity?",
    options: ["Supertype entity", "Subtype entity", "Archetype entity", "Instance entity"],
    answer: "D",
    explanation: [
        { type: 'discuss', content: "No answer description is available."}
    ]
  },
  {
    ...
    options: ["itself", "a subtype entity", "an archetype entity", "an instance entity"],
    answer: "A",
    explanation: [
        { type: 'discuss', content: "No answer description is available." }
    ]
...
// --- MAIN PAGE COMPONENT ---
export default function DataModelingWithErModelPage() {
    ...
    <div className="bg-white min-h-screen">
      <main className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
        <div className="border border-gray-200 rounded-lg p-6">
          <p className="text-sm text-gray-500 mb-4">Exercise : <span className="font-semibold text-green-600">Data Modeling with ER Model</span></p>
