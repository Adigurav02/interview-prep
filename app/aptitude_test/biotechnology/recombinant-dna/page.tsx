...
// --- DATA: This data is specific to the Recombinant DNA page ---
...
const generalQuestions = [
  {
    ...
    options: ["southern blotting", "northern blotting", "polymerase chain reaction", "DNA replication"],
    answer: "C",
    explanation: [
  ...
  {
    question: "The Southern blotting technique depends on",
    options: [
  ...
  {
    question: "Problems in obtaining large amounts of proteins encoded by recombinant genes can often be overcome by using",
    options: ["BACS", "expression vectors", "YACS", "all of these"],
    answer: "B",
    explanation: [
      { type: 'discuss', content: "No answer description is available." }
    ]
  ...
  {
    question: "In genetic engineering, a chimera is",
    options: [
...
// --- MAIN PAGE COMPONENT ---
export default function RecombinantDnaPage() {
    ...
    <div className="bg-white min-h-screen">
      <main className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
        <div className="border border-gray-200 rounded-lg p-6">
          <p className="text-sm text-gray-500 mb-4">Exercise : <span className="font-semibold text-green-600">Recombinant DNA</span></p>
