...
// --- DATA: This data is specific to the Plant Cell Culture page ---
...
const generalQuestions = [
  {
    question: "A(n) ________ is an excised piece of leaf or stem tissue used in micropropagation.",
    options: ["microshoot", "medium", "explant", "scion"],
    answer: "C",
    explanation: [
  ...
  {
    question: "Protoplasts can be produced from suspension cultures, callus tissues or intact tissues by enzymatic treatment with",
    options: [
  ...
  {
    question: "Which of the following is considered as the disadvantage of conventional plant tissue culture for clonal propagation?",
    options: [
  ...
  {
    question: "What is meant by 'Organ culture' ?",
    options: [
  ...
  {
    question: "Which method of plant propagation involves the use of girdling?",
    options: ["Grafting", "Cuttings", "Layering", "Micropropagation"],
    answer: "C",
    explanation: [
        { type: 'discuss', content: "No answer description is available." }
    ]
...
// --- MAIN PAGE COMPONENT ---
export default function PlantCellCulturePage() {
    ...
    <div className="bg-white min-h-screen">
      <main className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
        <div className="border border-gray-200 rounded-lg p-6">
          <p className="text-sm text-gray-500 mb-4">Exercise : <span className="font-semibold text-green-600">Plant Cell Culture</span></p>
