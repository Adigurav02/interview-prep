...
// --- DATA: This data is specific to the General Plant Biotechnology page ---
...
const generalQuestions = [
  {
    question: "Which group of plants has the greatest diversity (i.e. the most species) living today?",
    options: ["Bryophyta", "Lycophyta", "Gymnosperms", "Angiosperms"],
    answer: "D",
    explanation: [
  ...
  {
    question: "Which group of land plants is most restricted to moist environments?",
    options: ["Lycophyta", "Sphenophyta", "Bryophyta", "Angiosperms"],
    answer: "C",
    explanation: [
      { type: 'discuss', content: "No answer description is available." }
    ]
  ...
  {
    question: "What single feature is probably most responsible for the success of angiosperms?",
    options: ["Seeds", "Fruit", "Broad leaves", "Flowers"],
    answer: "D",
    explanation: [
      { type: 'discuss', content: "No answer description is available." }
    ]
  ...
  {
    question: "Auxanometer is used for measuring",
    options: ["respiratory activity", "photosynthetic activity", "growth activity", "osmotic pressure"],
    answer: "C",
    explanation: [
        { type: 'discuss', content: "No answer description is available."}
    ]
  },
  {
    ...
    options: ["haploid", "diploid", "triploid", "none of these"],
    answer: "C",
    explanation: [
        { type: 'discuss', content: "No answer description is available." }
    ]
...
// --- MAIN PAGE COMPONENT ---
export default function GeneralPlantBiotechnologyPage() {
    ...
    <div className="bg-white min-h-screen">
      <main className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
        <div className="border border-gray-200 rounded-lg p-6">
          <p className="text-sm text-gray-500 mb-4">Exercise : <span className="font-semibold text-green-600">General Plant Biotechnology</span></p>
