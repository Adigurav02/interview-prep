...
// --- DATA: This data is specific to the Biosensors and Biochips page ---
...
const generalQuestions = [
  {
    ...
    options: ["gene or gene products", "whole genome", "both (a) and (b)", "none of these"],
    answer: "A",
    explanation: [
  ...
  },
  {
    ...
    options: [
        ...
        "conducting molecules inserted into the protein frame work", 
        "non-conducting molecules inserted into the protein frame work", 
        "any of the above"
    ],
    answer: "A",
    explanation: [
  ...
  {
    question: "Hypoxanthine can be measured by",
    options: ["hypoxanthine sensor", "amorphous silicon ISFET", "urea sensor", "alcohol sensor"],
    answer: "A",
    explanation: [
      { type: 'discuss', content: "No answer description is available." }
    ]
  ...
  {
    question: "Which of the following technology is used for micro array manufacturing?",
    options: ["Photolithography", "Ink jetting", "Contact printing", "All of these"],
    answer: "D",
    explanation: [
        { type: 'discuss', content: "No answer description is available."}
    ]
  ...
  {
    question: "Which of the following adaptations would it be desirable for a farmer to breed into a crop of wheat?",
    options: ["Early ripening", "Resistance to disease", "Resistance to pests", "All of these"],
    answer: "D",
    explanation: [
        { type: 'discuss', content: "No answer description is available." }
    ]
...
// --- MAIN PAGE COMPONENT ---
export default function BiosensorsAndBiochipsPage() {
    ...
    <div className="bg-white min-h-screen">
      <main className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
        <div className="border border-gray-200 rounded-lg p-6">
          <p className="text-sm text-gray-500 mb-4">Exercise : <span className="font-semibold text-green-600">Biosensors and Biochips</span></p>
