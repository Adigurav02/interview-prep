...
// --- DATA: This data is specific to the Plant Genetics page ---
...
const generalQuestions = [
  {
    question: "In case of incomplete dominance, the phenotypic ratio of a monohybrid cross will be",
    options: ["1:2:1", "3:1:1", "1:3:1", "1:1:2"],
    answer: "A",
    explanation: [
  ...
  {
    question: "What is the approximate size (in kb) of the melon mitochondrial genome?",
    options: ["600 kilobase", "1200 kilobase", "2400 kilobase", "3000 kilobase"],
    answer: "C",
    explanation: [
      { type: 'discuss', content: "No answer description is available." }
    ]
  ...
  {
    question: "When an organism has a life cycle with alternation of generations, the haploid generation is the",
    options: ["zygote", "gametophyte", "gamete", "sporophyte"],
    answer: "B",
    explanation: [
        { type: 'discuss', content: "No answer description is available."}
    ]
  ...
  {
    question: "When do kinetochore microtubules pull chromosomes towards opposite spindle poles?",
    options: ["In anaphase A", "In anaphase B", "In metaphase", "In telophase"],
    answer: "A",
    explanation: [
        { type: 'discuss', content: "No answer description is available." }
    ]
...
// --- MAIN PAGE COMPONENT ---
export default function PlantGeneticsPage() {
    ...
    <div className="bg-white min-h-screen">
      <main className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
        <div className="border border-gray-200 rounded-lg p-6">
          <p className="text-sm text-gray-500 mb-4">Exercise : <span className="font-semibold text-green-600">Plant Genetics</span></p>
