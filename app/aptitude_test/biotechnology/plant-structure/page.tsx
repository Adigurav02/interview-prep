...
// --- DATA: This data is specific to the Plant Structure page ---
...
const generalQuestions = [
  {
    question: "Any system that is not at equilibrium",
    options: [
  ...
  {
    question: "The element neon (Ne) has eight electrons in its outermost electron shell. How many covalent bonds will Ne readily form?",
  ...
  {
    question: "Which of the following functional groups would make a carbon-based compound the least polar?",
    options: ["Phosphate", "Methyl", "Carboxyl", "Amino"],
    answer: "B",
    explanation: [
      { type: 'discuss', content: "No answer description is available." }
    ]
  ...
  {
    question: "Which is not true about a photon?",
    options: [
  ...
  {
    question: "If the ends of the following polysaccharide are pulled, which one would stretch the most?",
    options: ["Glycogen", "Starch", "Cellulose", "None of these"],
    answer: "B",
    explanation: [
        { type: 'discuss', content: "No answer description is available." }
    ]
    ...
    <div className="bg-white min-h-screen">
      <main className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
        <div className="border border-gray-200 rounded-lg p-6">
          <p className="text-sm text-gray-500 mb-4">Exercise : <span className="font-semibold text-green-600">Plant Structure</span></p>
