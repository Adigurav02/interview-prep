...
// --- DATA: This data is specific to the Biotechnology category page ---
...
export default function BiotechnologyPage() {
  const parentSlug = "biotechnology"; // This should match the folder name
  const title = "Biotechnology";
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-x-8 gap-y-4">
          {biotechnologyTopics.map(topic => (
            ...
            // For example: /aptitude_test/biotechnology/recombinant-dna
            <Link 
              key={topic} 
