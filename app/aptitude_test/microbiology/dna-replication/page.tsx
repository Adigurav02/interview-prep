...
// --- DATA: This data is specific to the DNA Replication page ---
...
const generalQuestions = [
  {
    question: "Both strands of DNA serve as templates concurrently in",
    options: ["replication", "excision repair", "mismatch repair", "none of these"],
    answer: "A",
    explanation: [
  ...
  {
    question: "Proofreading activity to maintain the fidelity of DNA synthesis",
    options: [
  ...
  {
    question: "Which of the following repairs nicked DNA by forming a phosphodiester bond between adjacent nucleotides?",
    options: ["Helicase", "DNA gyrase", "Topoisomerases", "DNA ligase"],
    answer: "D",
    explanation: [
      { type: 'discuss', content: "No answer description is available." }
    ]
  ...
  {
    question: "The enzyme that catalyzes the synthesis of DNA is called",
    options: ["DNA polymerase", "DNA gyrase", "DNA ligase", "helicase"],
    answer: "A",
    explanation: [
        { type: 'discuss', content: "No answer description is available."}
    ]
  ...
  {
    question: "Which of the following possesses both 5'->3' and 3'->5' exonuclease activity?",
    options: ["Kornberg enzyme", "DNA polymerase III", "Taq DNA polymerase", "None of these"],
    answer: "A",
    explanation: [
        { type: 'discuss', content: "No answer description is available." }
    ]
    ...
    <div className="bg-white min-h-screen">
      <main className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
        <div className="border border-gray-200 rounded-lg p-6">
          <p className="text-sm text-gray-500 mb-4">Exercise : <span className="font-semibold text-green-600">DNA Replication</span></p>
