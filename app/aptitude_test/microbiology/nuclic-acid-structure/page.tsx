...
// --- DATA: This data is specific to the DNA Sequencing, Mutation and Repair page ---
...
const generalQuestions = [
  {
    question: "In DNA sequencing, the primer",
    options: [
  ...
  {
    question: "The chromosome of almost all bacteria is in the shape of",
    options: ["an open circle", "helix", "a closed circle", "a linear chromosome"],
    answer: "C",
    explanation: [
      { type: 'discuss', content: "No answer description is available." }
    ]
  ...
  {
    question: "In which of the following uracil is present?",
    options: ["RNA", "DNA", "Both (a) and (b)", "None of these"],
    answer: "A",
    explanation: [
      { type: 'discuss', content: "No answer description is available." }
    ]
  ...
  {
    question: "To which of the following adenine always binds?",
    options: ["Guanine", "Cytosine", "Thymine", "None of these"],
    answer: "C",
    explanation: [
        { type: 'discuss', content: "No answer description is available."}
    ]
  ...
  {
    question: "Guanine always binds to",
    options: ["cytosine", "guanine", "thymine", "none of these"],
    answer: "A",
    explanation: [
        { type: 'discuss', content: "No answer description is available." }
    ]
...
// --- MAIN PAGE COMPONENT ---
export default function DnaSequencingMutationAndRepairPage() {
    ...
    <div className="bg-white min-h-screen">
      <main className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
        <div className="border border-gray-200 rounded-lg p-6">
          <p className="text-sm text-gray-500 mb-4">Exercise : <span className="font-semibold text-green-600">DNA Sequencing, Mutation and Repair</span></p>
