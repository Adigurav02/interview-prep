...
// --- DATA: This data is specific to the Identification of Bacteria page ---
...
const generalQuestions = [
  {
    question: "The gram-negative organisms is",
    options: ["Actinomyces", "Bacillus", "Clostridium", "None of these"],
    answer: "D",
    explanation: [
  ...
  },
  {
    ...
    options: ["Streptococcus", "Salmonella", "Proteus", "Staphylococcus"],
    answer: "A",
    explanation: [
      { type: 'discuss', content: "No answer description is available." }
    ]
  },
  {
    ...
    options: ["Methylene blue", "Bromocresol green", "Safranin", "Phenolphthalene"],
    answer: "A",
    explanation: [
      { type: 'discuss', content: "No answer description is available." }
    ]
  ...
  {
    question: "The organisms that can be acid-fast stained is",
    options: ["Nocardia", "Tubercle bacilli", "Lepra bacilli", "all of these"],
    answer: "D",
    explanation: [
        { type: 'discuss', content: "No answer description is available." }
    ]
...
// --- MAIN PAGE COMPONENT ---
export default function IdentificationOfBacteriaPage() {
    ...
    <div className="bg-white min-h-screen">
      <main className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
        <div className="border border-gray-200 rounded-lg p-6">
          <p className="text-sm text-gray-500 mb-4">Exercise : <span className="font-semibold text-green-600">Identification of Bacteria</span></p>
