...
// --- DATA: This data is specific to the Microorganisms and Disease page ---
...
const generalQuestions = [
  {
    question: "Which of the following characteristic of the Rotavirus was important for the construction of the Rotashield vaccine?",
    options: [
  ...
  {
    question: "Plastic implants can pose a serious nosocomial infection problem because",
    options: [
  ...
  {
    question: "A major difference between EHEC and EPEC is",
    options: [
  ...
  {
    question: "The nature of the poliovirus gives for oral vaccination (satin vaccine) as part of the eradication programme is",
    options: [
        "heat killed virus", 
  ...
  {
    question: "Which of the following is true regarding anthrax?",
    options: [
...
// --- MAIN PAGE COMPONENT ---
export default function MicroorganismsAndDiseasePage() {
    ...
    <div className="bg-white min-h-screen">
      <main className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
        <div className="border border-gray-200 rounded-lg p-6">
          <p className="text-sm text-gray-500 mb-4">Exercise : <span className="font-semibold text-green-600">Microorganisms and Disease</span></p>
