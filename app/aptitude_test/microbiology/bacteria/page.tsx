...
// --- DATA: This data is specific to the Bacteria page ---
...
const generalQuestions = [
  {
    question: "Which of the following is/are not a gram-positive bacteria?",
    options: ["Streptococci", "Pseudomonas", "Mycobacteria", "None of these"],
    answer: "B",
    explanation: [
  ...
  {
    question: "Gram-positive bacteria, responsible for food poisoning, is/are",
    options: ["Mycoplasmas", "Pseudomonas", "Clostridia", "all of these"],
    answer: "C",
    explanation: [
      { type: 'discuss', content: "No answer description is available." }
    ]
  ...
  {
    question: "The gram-positive bacteria lack ________ structure/component?",
    options: ["outer membrane", "murein", "teichoic acid", "plasma membrane"],
    answer: "A",
    explanation: [
      { type: 'discuss', content: "No answer description is available." }
    ]
  ...
  {
    question: "Which of the following gram-positive bacteria causes pharyngitis (sore throat)?",
    options: ["Neisseria", "Streptococcus", "Staphylococcus", "Mycobacterium"],
    answer: "B",
    explanation: [
        { type: 'discuss', content: "No answer description is available."}
    ]
  ...
  {
    question: "Which of the following gram-negative bacteria is/are not aerobic?",
    options: ["Pseudomonas", "Neisseria", "Escherichia", "None of these"],
    answer: "C",
    explanation: [
        { type: 'discuss', content: "No answer description is available." }
    ]
    ...
    <div className="bg-white min-h-screen">
      <main className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
        <div className="border border-gray-200 rounded-lg p-6">
          <p className="text-sm text-gray-500 mb-4">Exercise : <span className="font-semibold text-green-600">Bacteria</span></p>
