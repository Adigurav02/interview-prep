...
// --- DATA: This data is specific to the Viruses page ---
...
const generalQuestions = [
  {
    question: "Which of the following disinfectant is effective against viruses?",
    options: ["Hydrogen peroxide", "Hypochlorite", "Formaldehyde", "All of these"],
    answer: "D",
    explanation: [
  ...
  },
  {
    ...
    options: ["protein", "carbohydrate", "alcohol", "all of these"],
    answer: "A",
    explanation: [
      { type: 'discuss', content: "No answer description is available." }
    ]
  ...
  {
    question: "Viruses require ________ for growth.",
    options: ["bacteria", "plants", "animals", "living cells"],
    answer: "D",
    explanation: [
      { type: 'discuss', content: "No answer description is available." }
    ]
  ...
  {
    question: "The sequence of nucleic acid in a variety of viruses and viral host, will find more similarities",
    options: [
    ...
    <div className="bg-white min-h-screen">
      <main className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
        <div className="border border-gray-200 rounded-lg p-6">
          <p className="text-sm text-gray-500 mb-4">Exercise : <span className="font-semibold text-green-600">Viruses</span></p>
