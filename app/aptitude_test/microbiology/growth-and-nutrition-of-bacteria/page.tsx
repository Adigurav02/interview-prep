...
// --- DATA: This data is specific to the Growth and Nutrition of Bacteria page ---
...
const generalQuestions = [
  {
    question: "Which of the following is not the characteristic of a growth curve?",
    options: [
  ...
  {
    question: "Generation time of Escherichia coli is",
    options: ["20 minutes", "20 hours", "20 days", "200 hours"],
    answer: "A",
    explanation: [
      { type: 'discuss', content: "No answer description is available." }
    ]
  ...
  {
    question: "The organism which obtain their energy from chemicals are designated as",
    options: ["prototrophs", "chemotrophs", "organotrophs", "autotrophs"],
    answer: "B",
    explanation: [
      { type: 'discuss', content: "No answer description is available." }
    ]
  ...
  {
    question: "Nutrient content and biological structures are considered as",
    options: [
  ...
  {
    question: "The organism which grows best above 45°C are called",
    options: ["psychrophilic", "mesophilic", "thermophilic", "any of these"],
    answer: "C",
    explanation: [
        { type: 'discuss', content: "No answer description is available." }
    ]
...
// --- MAIN PAGE COMPONENT ---
export default function GrowthAndNutritionOfBacteriaPage() {
    ...
    <div className="bg-white min-h-screen">
      <main className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
        <div className="border border-gray-200 rounded-lg p-6">
          <p className="text-sm text-gray-500 mb-4">Exercise : <span className="font-semibold text-green-600">Growth and Nutrition of Bacteria</span></p>
