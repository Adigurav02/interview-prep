...
// --- DATA: This data is specific to the Current Affairs category page ---
...
export default function CurrentAffairsPage() {
  const parentSlug = "current-affairs"; // This should match the folder name
  const title = "Current Affairs by Category";
    ...
    <div className="bg-white min-h-screen">
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="flex items-center gap-4 mb-8 pb-4 border-b border-gray-200">
            ...
            <div>
                <p className="text-sm font-semibold text-green-600 uppercase tracking-wide">Current Affairs by Category</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-4">
          {currentAffairsCategories.map(topic => (
            // Each link will point to a future page for that specific category
            // For example: /aptitude_test/current-affairs/art-and-culture
            <Link 
              key={topic} 
