...
// --- DATA: This data is specific to the Thermodynamics page ---
...
const generalQuestions = [
  ...
  },
  {
    ...
    options: ["specific heat at constant volume", "specific heat at constant pressure", "kilo Joule", "none of these"],
    answer: "A",
    explanation: [
      { type: 'discuss', content: "No answer description is available." }
    ]
    ...
    <div className="bg-white min-h-screen">
      <main className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
        <div className="border border-gray-200 rounded-lg p-6">
          <p className="text-sm text-gray-500 mb-4">Exercise : <span className="font-semibold text-green-600">Thermodynamics - Section 1</span></p>
