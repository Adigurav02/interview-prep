...
// --- DATA: This data is specific to the Engineering Mechanics page ---
...
const generalQuestions = [
  ...
  },
  {
    ...
    options: ["rolling friction", "dynamic friction", "limiting friction", "static friction"],
    answer: "B",
    explanation: [
      { type: 'discuss', content: "No answer description is available." }
    ]
  ...
  {
    question: "Two balls of equal mass and of perfectly elastic material are lying on the floor. One of the ball with velocity v is made to struck the second ball. Both the balls after impact will move with a velocity",
    options: ["v", "v/2", "v/4", "v/8"],
    answer: "B",
    explanation: [
      { type: 'discuss', content: "No answer description is available." }
    ]
  ...
  {
    question: "The term 'force' may be defined as an agent which produces or tends to produce, destroys or tends to destroy motion.",
  ...
  {
    question: "The coefficient of restitution for elastic bodies is one.",
    options: ["Correct", "Incorrect"],
    answer: "B",
    explanation: [
      { type: 'text', content: 'Coefficient of restitution for elastic bodies is 0 - 1.' },
      { type: 'text', content: 'Coefficient of restitution for perfect elastic bodies is 1.' }
    ]
  }
];
...
// --- MAIN PAGE COMPONENT ---
export default function EngineeringMechanicsPage() {
    ...
    <div className="bg-white min-h-screen">
      <main className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
        <div className="border border-gray-200 rounded-lg p-6">
          <p className="text-sm text-gray-500 mb-4">Exercise : <span className="font-semibold text-green-600">Engineering Mechanics - Section 1</span></p>
