...
// --- DATA: This data is specific to the Mechanical Engineering category page ---
...
export default function MechanicalEngineeringPage() {
  const parentSlug = "mechanical-engineering"; // This should match the folder name
  const title = "Mechanical Engineering";
    ...
    <div className="bg-white min-h-screen">
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="flex items-center gap-4 mb-8 pb-4 border-b border-gray-200">
            ...
            <div>
                <p className="text-sm font-semibold text-green-600">Engineering Topics</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-4">
          {engineeringTopics.map(topic => (
            ...
            // For example: /aptitude_test/mechanical-engineering/engineering-mechanics
            <Link 
              key={topic} 
