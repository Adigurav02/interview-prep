...
// --- DATA: This data is specific to the Strength of Materials page ---
...
const generalQuestions = [
  ...
  {
    question: "A vertical column has two moments of inertia (i.e. Ixx and Iyy ). The column will tend to buckle in the direction of the",
    options: [
        "axis of load", 
  ...
  {
    question: "The neutral axis of the cross-section a beam is that axis at which the bending stress is",
    options: ["zero", "minimum", "maximum", "infinity"],
    answer: "A",
    explanation: [
      { type: 'discuss', content: "No answer description is available." }
    ]
  ...
  {
    question: "Euler's formula holds good only for",
    options: ["short columns", "long columns", "both short and long columns", "weak columns"],
    answer: "B",
    explanation: [
      { type: 'discuss', content: "No answer description is available." }
    ]
  ...
  {
    question: "The object of caulking in a riveted joint is to make the joint",
    options: ["free from corrosion", "stronger in tension", "free from stresses", "leak-proof"],
    answer: "D",
    explanation: [
      { type: 'discuss', content: "No answer description is available." }
    ]
    ...
    <div className="bg-white min-h-screen">
      <main className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
        <div className="border border-gray-200 rounded-lg p-6">
          <p className="text-sm text-gray-500 mb-4">Exercise : <span className="font-semibold text-green-600">Strength of Materials - Section 1</span></p>
