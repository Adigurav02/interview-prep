...
// --- DATA: This data is specific to the Steam Boilers and Engines page ---
...
const generalQuestions = [
  {
    question: "The object of producing draught in a boiler is",
    options: [
  ...
  {
    question: "In a glass tube type water indicator for a boiler, one end of the tube is connected to water space and the other end is connected to",
    options: [
        "water space also", 
        "chimney", 
        "steam space", 
  ...
  {
    question: "In water tube boilers",
    options: [
  ...
  {
    question: "A grate, in a boiler, is a place in the combustion chamber upon which fuel (wood or coal) is burnt.",
    options: ["True", "False"],
    answer: "A",
    explanation: [
      { type: 'discuss', content: "No answer description is available." }
...
// --- MAIN PAGE COMPONENT ---
export default function SteamBoilersAndEnginesPage() {
    ...
    <div className="bg-white min-h-screen">
      <main className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
        <div className="border border-gray-200 rounded-lg p-6">
          <p className="text-sm text-gray-500 mb-4">Exercise : <span className="font-semibold text-green-600">Steam Boilers and Engines - Section 1</span></p>
