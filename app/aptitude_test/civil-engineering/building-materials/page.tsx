...
// --- DATA: This data is specific to the Building Materials page ---
...
const generalQuestions = [
  ...
  {
    question: "Pick up the polymineralic rock from the following;",
    options: ["Quartz sand", "Pure gypsum", "Magnesite", "Granite", "None of these."],
    answer: "D",
    explanation: [
      { type: 'text', content: "Granite is a polymineralic rock, which means it is composed of a mixture of minerals. Granite is typically made up of quartz, feldspar, and mica, as well as smaller amounts of other minerals. The different minerals in granite give it a variety of colors and patterns, ranging from white to pink to black." }
    ]
  },
  {
    ...
    <div className="bg-white min-h-screen">
      <main className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
        <div className="border border-gray-200 rounded-lg p-6">
          <p className="text-sm text-gray-500 mb-4">Exercise : <span className="font-semibold text-green-600">Building Materials - Section 1</span></p>
