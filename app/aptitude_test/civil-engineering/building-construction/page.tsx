...
// --- DATA: This data is specific to the Building Construction page ---
...
const generalQuestions = [
  ...
  {
    question: "Queen closer may be placed",
    options: [
        "in header course", 
        "in stretcher course", 
  ...
  {
    question: "Dado is usually provided in",
    options: ["dinning halls", "bath rooms", "living rooms", "verandah", "roofs."],
    answer: "B",
    explanation: [
      { type: 'discuss', content: "No answer description is available." }
    ]
  ...
  {
    question: "The foundation in which a cantilever beam is provided to join two footings, is known as",
    options: ["strip footing", "strap footing", "combined footing", "raft footing", "none of these."],
    answer: "B",
    explanation: [
      { type: 'discuss', content: "No answer description is available." }
    ]
  ...
  {
    question: "The foundations are placed below ground level, to increase",
    options: [
        "strength", 
        "workability", 
    ...
    <div className="bg-white min-h-screen">
      <main className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
        <div className="border border-gray-200 rounded-lg p-6">
          <p className="text-sm text-gray-500 mb-4">Exercise : <span className="font-semibold text-green-600">Building Construction - Section 1</span></p>
