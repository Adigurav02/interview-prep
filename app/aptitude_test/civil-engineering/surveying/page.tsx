...
// --- DATA: This data is specific to the Surveying page ---
...
const generalQuestions = [
  {
    question: "Hydrographic surveys deal with the mapping of",
    options: [
        "large water bodies", 
        "heavenly bodies", 
        "mountaineous region", 
  ...
  {
    question: "If h is the difference in level between end points separated by l, then the slope correction is (h²/2l) - (h⁴/8l³). The second term may be neglected if the value of h in a 20 m distance is less than",
    options: [
        "1/2 m", 
        "1 m", 
        "2 m", 
  ...
  {
    question: "An ideal vertical curve to join two gradients, is",
    options: ["circular", "parabolic", "elliptical", "hyperbolic", "none of these."],
    answer: "B",
    explanation: [
      { type: 'discuss', content: "No answer description is available." }
    ]
  ...
  {
    question: "The intercept of a staff",
    options: [
    ...
    <div className="bg-white min-h-screen">
      <main className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
        <div className="border border-gray-200 rounded-lg p-6">
          <p className="text-sm text-gray-500 mb-4">Exercise : <span className="font-semibold text-green-600">Surveying - Section 1</span></p>
