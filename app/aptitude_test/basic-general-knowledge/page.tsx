...
// --- DATA: This data is specific to the Basic General Knowledge page ---

const subPageLinks = ["Basic General Knowledge - Questions"];
...
const generalQuestions = [
  ...
  },
  {
    ...
    answer: "B",
    explanation: [
      { type: 'text', content: "Entomology: The branch of zoology concerned with the study of insects." },
    ]
  },
  {
...
// --- Reusable Components (Modified Explanation component) ---
...
// --- MAIN PAGE COMPONENT ---
export default function BasicGeneralKnowledgePage() {
    ...
    <div className="bg-white min-h-screen">
      <main className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
        <div className="border border-gray-200 rounded-lg p-6">
          <p className="text-sm text-gray-500 mb-4">Exercise : <span className="font-semibold text-green-600">Basic General Knowledge</span></p>
