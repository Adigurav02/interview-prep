...
// --- DATA: This data is specific to the Wireless Technologies page ---

const subPageLinks = [
    "Wireless Technologies - Section 1",
    "Wireless Technologies - Section 2",
];
...
const generalQuestions = [
  {
    ...
    answer: "D",
    explanation: [
      { type: 'text', content: "The IEEE 802.11a standard runs in the 5GHz RF range." }
    ]
  },
  {
    question: "What is the maximum distance running the lowest data rate for 802.11b?",
    options: ["About 100 feet", "About 175 feet", "About 300 feet", "About 350 feet"],
    answer: "D",
    explanation: [
      { type: 'text', content: "The IEEE 802.11b standard provides the lowest data rate at 1Mbps, but it also has the longest distance, which is about 350 feet." }
    ]
  },
  {
    question: "What is the maximum distance with maximum data rate for 802.11a?",
    options: ["About 65-75 feet", "About 90-100 feet", "About 150 feet", "Over 200 feet"],
    answer: "A",
    explanation: [
      { type: 'text', content: "The IEEE 802.11a standard provides a maximum data rate of up to 54Mbps, but you need to be close to the access point, somewhere around 65 to 75 feet." }
    ]
  },
  {
    ...
    answer: "C",
    explanation: [
        { type: 'text', content: "The IEEE 802.11b and IEEE 802.11g standards both run in the 2.4GHz RF range."}
    ]
  },
  {
    ...
    options: ["LWAPP", "AWPP", "STP", "IEEE"],
    answer: "B",
    explanation: [
        { type: 'text', content: "Each AP in a mesh network runs the Adaptive Wireless Path Protocol (AWPP). This protocol allows RAPs to communicate with each other to determine the best path back to the wired network via the RAP." }
    ]
  }
];
...
// --- MAIN PAGE COMPONENT ---
export default function WirelessTechnologiesPage() {
    ...
    <div className="bg-white min-h-screen">
      <main className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
        <div className="border border-gray-200 rounded-lg p-6">
          <p className="text-sm text-gray-500 mb-4">Exercise : <span className="font-semibold text-green-600">Wireless Technologies</span></p>
