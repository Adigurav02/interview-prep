...
// --- DATA: This data is specific to the Networking Basics page ---

const subPageLinks = [
    "Networking Basics - Section 1",
    "Networking Basics - Section 2",
    "Networking Basics - Section 3",
];
...
const generalQuestions = [
  {
    ...
    answer: "D",
    explanation: [
      { type: 'text', content: "An IPv6 address is 128 bits long." }
    ]
  },
  {
    ...
    options: ["NAT", "Static", "Dynamic", "PAT"],
    answer: "D",
    explanation: [
      { type: 'text', content: "Port Address Translation (PAT) allows a one-to-many approach to network address translation." }
    ]
  },
  {
    question: "What are the two main types of access control lists (ACLs)?\n1. Standard\n2. IEEE\n3. Extended\n4. Specialized",
    options: ["1 and 3", "2 and 4", "3 and 4", "1 and 2"],
    answer: "A",
    explanation: [
      { type: 'text', content: "Standard and extended access control lists (ACLs) are used to configure security on a router." }
    ]
  },
  {
    ...
    answer: "B",
    explanation: [
        { type: 'highlighted-text', content: "The command to back up the configuration on a router is copy running-config startup-config."}
    ]
  },
  {
    ...
    options: ["100 kbps", "1 Mbps", "2 Mbps", "10 Mbps"],
    answer: "D",
    explanation: [
        { type: 'text', content: "Each device has 10 Mbps to the server." }
    ]
  }
];
...
const Explanation = ({ answer, explanation }: { answer: string, explanation: any[] }) => { 
    const renderHighlightedText = (text: string) => {
        const keywords = ['copy running-config startup-config'];
    ...
    <div className="bg-white min-h-screen">
      <main className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
        <div className="border border-gray-200 rounded-lg p-6">
          <p className="text-sm text-gray-500 mb-4">Exercise : <span className="font-semibold text-green-600">Networking Basics</span></p>
