...
// --- DATA: This data is specific to the C Arrays page ---
...
const generalQuestions = [
  {
    ...
    answer: "C",
    explanation: [
      { type: 'text', content: "If the index of the array size is exceeded, the program will crash. Hence \"option c\" is the correct answer. But the modern compilers will take care of this kind of errors." },
      { 
        type: 'code', 
        title: 'Example: Run the below program, it will crash in Windows (TurboC Compiler)', 
        code: '#include<stdio.h>\n\nint main()\n{\n   int arr[2];\n   arr[3]=10;\n   printf("%d", arr[3]);\n   return 0;\n}'
      },
      { type: 'text', content: "Since C is a compiler dependent language, it may give different outputs at different platforms. We have given the Turbo-C Compiler (Windows) output." },
      { type: 'text', content: "Please try the above programs in Windows (Turbo-C Compiler) and Linux (GCC Compiler), you will understand the difference better." }
    ]
  },
  {
  ...
  },
  {
    ...
    answer: "C",
    explanation: [
      { type: 'text', content: "The statement 'C' is correct. When we pass an array as a funtion argument, the base address of the array will be passed." }
    ]
  }
];
    ...
    <div className="bg-white min-h-screen">
      <main className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
        <div className="border border-gray-200 rounded-lg p-6">
          <p className="text-sm text-gray-500 mb-4">Exercise : <span className="font-semibold text-green-600">C - Arrays</span></p>
