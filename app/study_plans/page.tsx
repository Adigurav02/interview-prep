...
const allJobTypes = [ "Sales", "Marketing", "Business Analyst", "Operations", "Product Management", "Customer Success", "Data Analyst", "Software Engineering", "Project Management", "Consulting", "Program Management", "Management", "Backend Software Engineer", "Full Stack Software Engineer", "Frontend Software Engineer", "Design", "General", "Human Resources", "Administrative", "Recruiting", "Public Relations", "Quality Assurance", "Cybersecurity", "Finance", "Legal Services", "Quantitative Research", "Quantitative Trading", "Other", "Technical Program Manager", "Network Engineer", "Sales Engineer", "Cloud Support Engineer", "Data Science Manager", "Design Verification Engineer", "Data Engineer", "Engineering Manager", "Solutions Engineer", "Customer Service Representative", "Data Engineering Manager", "ML Engineering Manager", "Backend Engineer", "Frontend Engineer", "Product Marketing Manager", "Site Reliability Engineer", "Customer Experience Lead", "Quality Assurance Engineer", "Data Scientist", "UX Researcher", "Production Engineer", "Embedded Engineer", "Program Manager", "iOS Engineer", "Software Engineer", "UX Designer", "Android Engineer", "Machine Learning Engineer", "Site Reliability Engineering Manager" ];
